package net.blockheaven.kaipr.heavenactivity.register.payment;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new net.blockheaven.kaipr.heavenactivity.register.payment.methods.iCo6());
        this.addMethod("iConomy", new net.blockheaven.kaipr.heavenactivity.register.payment.methods.iCo5());
        this.addMethod("iConomy", new net.blockheaven.kaipr.heavenactivity.register.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new net.blockheaven.kaipr.heavenactivity.register.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new net.blockheaven.kaipr.heavenactivity.register.payment.methods.BOSE7());
        this.addMethod("Essentials", new net.blockheaven.kaipr.heavenactivity.register.payment.methods.EE17());
        this.addMethod("MultiCurrency", new net.blockheaven.kaipr.heavenactivity.register.payment.methods.MCUR());
    }
